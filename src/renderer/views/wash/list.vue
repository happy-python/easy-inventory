<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="洗入产品名称" align="center">
        <template slot-scope="scope">
          {{ scope.row.in_product_name_list }}
        </template>
      </el-table-column>
      <el-table-column label="洗入数量" align="center">
        <template slot-scope="scope">
          {{ scope.row.in_product_number_list }}
        </template>
      </el-table-column>
      <el-table-column label="洗出产品名称" align="center">
        <template slot-scope="scope">
          {{ scope.row.out_product_name }}
        </template>
      </el-table-column>
      <el-table-column label="洗出数量" align="center">
        <template slot-scope="scope">
...
<script>
import { delWash, paginationWash, countWash } from "@/api/database";
